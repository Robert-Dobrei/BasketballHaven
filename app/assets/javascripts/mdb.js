        ...
        (n = [
                ...
                if (o("RegExp", b)) {
                    function j(t, e) {
                        ...
                        if (
                            ...
                            (e = void 0 === e ? "" : f(e)),
                            (c = t),
                            (r = e = y && "dotAll" in I && (n = !!e && -1 < S(e, "s")) ? L(e, /s/g, "") : e),
                    ...
                    for (var M = r(x), P = 0; M.length > P; ) a(j, x, M[P++]);
                ...
                var i = n(4),
                    ...
                    n = (t.exports = function (t, e, n) {
                        "Symbol(" === p(d(e), 0, 7) && (e = "[" + g(d(e), /^Symbol\(([^)]*)\)/, "$1") + "]"),
                            n && n.getter && (e = "get " + e),
                            n && n.setter && (e = "set " + e),
                            (!s(t, "name") || (c && t.name !== e)) && (a ? f(t, "name", { value: e, configurable: !0 }) : (t.name = e)),
                            _ && n && s(n, "arity") && t.length !== n.arity && f(t, "length", { value: n.arity });
                        try {
                            n && s(n, "constructor") && n.constructor ? a && f(t, "prototype", { writable: !1 }) : t.prototype && (t.prototype = void 0);
                        } catch (t) {}
                        n = u(t);
            ...
            function (t, e, n) {
                ...
                t.exports = function (t, e, n, i, o, r, s) {
                    ...
                    if (
                        (p && (p = w(p.call(new t()))) !== Object.prototype && p.next && (v || w(p) === S || (E ? E(p, S) : b(p[k]) || A(p, k, g)), x(p, i, !0, !0), v) && (T[i] = g),
                        O &&
                            o == D &&
                            d &&
                            d.name !== D &&
            ...
            function (N, t, e) {
                              ...
                              ((e = r
                                  ? ((d = t),
                                    ...
                                    function n(i) {
                                        ...
                                        for (let e = i["target"]; e && e !== this; e = e.parentNode) for (let t = o.length; t--; ) if (o[t] === e) return (i.delegateTarget = e), n.oneOff && it.off(d, i.type, p), p.apply(e, [i]);
                                        return null;
                                    })
                                  : ((u = t),
                                    (h = n),
                ...
                const it = {
                        ...
                        t.forEach((t) => {
                            it.on(i, "".concat(t.name, ".bs.").concat(o), (e) => {
                                ...
                                t.parametersToCopy &&
                                    ...
                                    it.trigger(i, "".concat(t.name, ".mdb.").concat(o), n);
                            });
                        });
                    },
                    off(s, a, t, e) {
                        if ("string" == typeof a && s) {
                            const [n, i, o] = tt(a, t, e),
                                r = o !== a,
                                c = Z(s);
                            e = "." === a.charAt(0);
                    ...
                    trigger(t, e, n) {
                        ...
                        let s,
                            ...
                            u = null;
                        return (
                            o && z && ((s = z.Event(e, n)), z(t).trigger(s), (a = !s.isPropagationStopped()), (c = !s.isImmediatePropagationStopped()), (l = s.isDefaultPrevented())),
                ...
                class b extends _ {
                    ...
                    show() {
                        c.hasClass(this._element, ee) &&
                            (s.off(this._buttonList, Xt), s.trigger(this._element, Jt), this._bindListOpenTransitionEnd(), c.addStyle(this._element, { height: "".concat(this._fullContainerHeight, "px") }), this._toggleVisibility(!0));
                    }
                    hide() {
                ...
                const ce = "backdrop",
                    ...
                    ue = { className: "modal-backdrop", clickCallback: null, isAnimated: !1, isVisible: !0, rootElement: "body" },
                    he = { className: "string", clickCallback: "(function|null)", isAnimated: "boolean", isVisible: "boolean", rootElement: "(element|string)" };
                ...
                const fe = ".".concat("bs.focustrap"),
                    ...
                    me = "backward",
                    _e = { autofocus: !0, trapElement: null },
                ...
                var ye = class extends g {
                    ...
                    activate() {
                        this._isActive ||
                            (this._config.autofocus && this._config.trapElement.focus(), f.off(document, fe), f.on(document, pe, (t) => this._handleFocusin(t)), f.on(document, ge, (t) => this._handleKeydown(t)), (this._isActive = !0));
                    }
                    deactivate() {
                ...
                const Se = { backdrop: !0, keyboard: !0, scroll: !1 },
                    Ie = { backdrop: "(boolean|string)", keyboard: "boolean", scroll: "boolean" };
                class ke extends m {
                    constructor(t, e) {
                    ...
                    show(t) {
                        this._isShown ||
                            f.trigger(this._element, xe, { relatedTarget: t }).defaultPrevented ||
                            ((this._isShown = !0),
                            this._backdrop.show(),
                            ...
                            this._queueCallback(
                                () => {
                                    (this._config.scroll && !this._config.backdrop) || this._focustrap.activate(), this._element.classList.add("show"), this._element.classList.remove(we), f.trigger(this._element, Ce, { relatedTarget: t });
                                },
                                this._element,
                                !0
                            ));
                    ...
                    hide() {
                        this._isShown &&
                            !f.trigger(this._element, Ae).defaultPrevented &&
                ...
                const We = ".bs.swipe",
                    ...
                    Ue = { endCallback: null, leftCallback: null, rightCallback: null },
                ...
                class Xe extends g {
                    ...
                    _initEvents() {
                        this._supportPointerEvents
                            ? (f.on(this._element, Qe, (t) => this._start(t)), f.on(this._element, Ve, (t) => this._end(t)), this._element.classList.add("pointer-event"))
                            : (f.on(this._element, Fe, (t) => this._start(t)), f.on(this._element, qe, (t) => this._move(t)), f.on(this._element, ze, (t) => this._end(t)));
                    }
                ...
                const an = "carousel",
                    ...
                    un = ".carousel-item";
                ln, un;
                const hn = { ArrowLeft: Je, ArrowRight: Ze },
                    dn = { interval: 5e3, keyboard: !0, pause: "hover", ride: !1, touch: !0, wrap: !0 },
                    fn = { interval: "(number|boolean)", keyboard: "boolean", pause: "(string|boolean)", ride: "(boolean|string)", touch: "boolean", wrap: "boolean" };
                class pn extends m {
                    constructor(t, e) {
                        super(t, e),
                            (this._interval = null),
                    ...
                    _addEventListeners() {
                        this._config.keyboard && f.on(this._element, nn, (t) => this._keydown(t)),
                            "hover" === this._config.pause && (f.on(this._element, on, () => this.pause()), f.on(this._element, rn, () => this._maybeEnableCycle())),
                    ...
                    _setActiveIndicatorElement(t) {
                        ...
                        this._indicatorsElement &&
                            ((e = y.findOne(ln, this._indicatorsElement)).classList.remove(cn), e.removeAttribute("aria-current"), (e = y.findOne('[data-mdb-slide-to="'.concat(t, '"]'), this._indicatorsElement))) &&
                            (e.classList.add(cn), e.setAttribute("aria-current", "true"));
                    }
                    _updateInterval() {
                ...
                f.on(document, _, "[data-mdb-slide], [data-mdb-slide-to]", function (t) {
                    var e = l(this);
                    e &&
                        e.classList.contains(an) &&
                        (t.preventDefault(), (t = pn.getOrCreateInstance(e)), (e = this.getAttribute("data-mdb-slide-to")) ? t.to(e) : "next" === p.getDataAttribute(this, "slide") ? t.next() : t.prev(), t._maybeEnableCycle());
                }),
                    f.on(window, v, () => {
                ...
                const Ln = "modal-open",
                    Sn = "modal-static";
                const In = { backdrop: !0, focus: !0, keyboard: !0 },
                ...
                class Dn extends m {
                    ...
                    show(t) {
                        this._isShown ||
                            ...
                            f.trigger(this._element, En, { relatedTarget: t }).defaultPrevented ||
                            ((this._isShown = !0), (this._isTransitioning = !0), this._scrollBar.hide(), document.body.classList.add(Ln), this._adjustDialog(), this._backdrop.show(() => this._showElement(t)));
                    }
                    hide() {
                        !this._isShown ||
                            this._isTransitioning ||
                            f.trigger(this._element, bn).defaultPrevented ||
                    ...
                    _showElement(t) {
                        ...
                        this._queueCallback(
                            () => {
                                this._config.focus && this._focustrap.activate(), (this._isTransitioning = !1), f.trigger(this._element, xn, { relatedTarget: t });
                            },
                            this._dialog,
                            this._isAnimated()
                        );
                ...
                _ = Dn;
                const jn = "modal",
                    Mn = [{ name: "show", parametersToCopy: ["relatedTarget"] }, { name: "shown", parametersToCopy: ["relatedTarget"] }, { name: "hide" }, { name: "hidePrevented" }, { name: "hidden" }];
                class Pn extends _ {
                    constructor(t, e) {
                        super(t, e), this._init();
                    }
                ...
                var xi = {
                    ...
                    fn: function (t) {
                        ...
                        a &&
                            ...
                            ((t = t.padding),
                            (n = r),
                            (n = wi("number" != typeof (t = "function" == typeof t ? t(Object.assign({}, n.rects, { placement: n.placement })) : t) ? t : Ei(t, Hn))),
                            (t = di(a)),
                            (o = "y" === l ? O : I),
                            (i = "y" === l ? L : S),
                ...
                function Ti(t) {
                    var e,
                        ...
                        d = s.y,
                        d = void 0 === d ? 0 : d,
                        f = "function" == typeof u ? u({ x: h, y: d }) : { x: h, y: d },
                        ...
                        _ =
                            (l &&
                                ((_ = "clientHeight"),
                                (e = "clientWidth"),
                                (v = _i(n)) === A(n) && "static" !== D((v = pi(n))).position && "absolute" === a && ((_ = "scrollHeight"), (e = "scrollWidth")),
                                (o !== O && ((o !== I && o !== S) || r !== Wn)) || ((g = L), (d = (d - ((t && v === m && m.visualViewport ? m.visualViewport.height : v[_]) - i.height)) * (c ? 1 : -1))),
                                (o !== I && ((o !== O && o !== L) || r !== Wn)) || ((p = S), (h = (h - ((t && v === m && m.visualViewport ? m.visualViewport.width : v[e]) - i.width)) * (c ? 1 : -1)))),
                            Object.assign({ position: a }, l && Ai)),
                        v = !0 === u ? ((o = { x: h, y: d }), (r = A(n)), (t = o.x), (o = o.y), (r = r.devicePixelRatio || 1), { x: ci(t * r) / r || 0, y: ci(o * r) / r || 0 }) : { x: h, y: d };
                    return (
                        (h = v.x),
                        (d = v.y),
                        c
                            ? Object.assign(
                                  {},
                                  _,
                                  (((e = {})[g] = s ? "0" : ""), (e[p] = f ? "0" : ""), (e.transform = (m.devicePixelRatio || 1) <= 1 ? "translate(" + h + "px, " + d + "px)" : "translate3d(" + h + "px, " + d + "px, 0)"), e)
                              )
                            : Object.assign({}, _, (((i = {})[g] = s ? d + "px" : ""), (i[p] = f ? h + "px" : ""), (i.transform = ""), i))
                    );
                }
                var Oi = {
                        name: "computeStyles",
                        ...
                        fn: function (t) {
                            var e = t.state,
                                ...
                                n = { placement: k(e.placement), variation: Ci(e.placement), popper: e.elements.popper, popperRect: e.rects.popper, gpuAcceleration: n, isFixed: "fixed" === e.options.strategy };
                            null != e.modifiersData.popperOffsets &&
                                (e.styles.popper = Object.assign({}, e.styles.popper, Ti(Object.assign({}, n, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: i, roundOffsets: t })))),
                                null != e.modifiersData.arrow && (e.styles.arrow = Object.assign({}, e.styles.arrow, Ti(Object.assign({}, n, { offsets: e.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: t })))),
                ...
                function Bi(t, e, n) {
                    return e === qn
                        ? Hi(
                              ...
                              (a = a.clientHeight),
                              (u = l = 0),
                              s && ((c = s.width), (a = s.height), (r = ui()) || (!r && "fixed" === o)) && ((l = s.offsetLeft), (u = s.offsetTop)),
                              { width: c, height: a, x: l + Pi(i), y: u })
                          )
                        : ii(e)
                        ? (((o = hi((r = e), !1, "fixed" === (o = n))).top = o.top + r.clientTop),
                ...
                function Wi(n, t, e, i) {
                    var o,
                        r =
                            "clippingParents" === t
                                ? ((s = Ri(gi((r = n)))),
                                  ii((o = 0 <= ["absolute", "fixed"].indexOf(D(r).position) && T(r) ? _i(r) : r))
                                      ? s.filter(function (t) {
                ...
                function qi(t, e) {
                    var i,
                        ...
                        s = Fi({ reference: r, element: l, strategy: "absolute", placement: n }),
                        ...
                        if (!h.modifiersData[t]._skip) {
                            for (
                                var n = e.mainAxis,
                                    ...
                                    e = k(s),
                                    n = n || (e === s || !g ? [ki(s)] : k((n = s)) === Rn ? [] : ((e = ki(n)), [ji(n), e, ji(e)])),
                                            ...
                                            k(e) === Rn
                                                ? ((n = h),
                                                  ...
                                                  (u = (i =
                                                      ...
                                                      return (t[e] = qi(n, { placement: e, boundary: o, rootBoundary: r, padding: s })[k(e)]), t;
                                                  }, {})),
                                ...
                                var y = a[b],
                                    ...
                                    x = 0 <= [O, L].indexOf(w),
                                    C = x ? "width" : "height",
                                    A = qi(h, { placement: y, boundary: f, rootBoundary: p, altBoundary: r, padding: d }),
                                    x = x ? (E ? S : I) : E ? L : O,
                ...
                var Ui = {
                    ...
                    fn: function (t) {
                        var e = t.state,
                            ...
                            r = qi(e, { elementContext: "reference" }),
                            s = qi(e, { altBoundary: !0 }),
                            r = Qi(r, n),
                            n = Qi(s, i, o),
                            s = Vi(r),
                            i = Vi(n);
                            ...
                            e = Un.reduce(function (t, e) {
                                ...
                                return (
                                    (t[e] =
                                        ...
                                        (i = (n[1] || 0) * r),
                                        0 <= [I, S].indexOf(o) ? { x: i, y: e } : { x: e, y: i })),
                                    t
                                );
                            }, {}),
                            n = (i = e[s.placement]).x,
                ...
                var Xi = {
                    ...
                    fn: function (t) {
                        var e = t.state,
                            t = t.name;
                        e.modifiersData[t] = Fi({ reference: e.rects.reference, element: e.rects.popper, strategy: "absolute", placement: e.placement });
                    },
                    data: {},
                };
                var Ki = {
                    ...
                    fn: function (t) {
                        var e,
                            ...
                            p = qi(u, { boundary: p, rootBoundary: g, padding: _, altBoundary: m }),
                            g = k(u.placement),
                            m = !(_ = Ci(u.placement)),
                            b = vi(g),
                            y = "x" === b ? "y" : "x",
                        ...
                        w &&
                            (d &&
                                ...
                                (l = bi(v ? ai(s, a + r - e - m) : s, a, v ? si(c, _) : c)),
                                (w[b] = l),
                                (A[b] = l - a)),
                            f &&
                                ((i = "y" == y ? "height" : "width"),
                                ...
                                (a = v && r ? ((c = bi((c = s), n, (l = _))), l < c ? l : c) : bi(v ? s : o, n, v ? _ : d)),
                                (w[y] = a),
                                (A[y] = a - n)),
                            (u.modifiersData[t] = A));
                    },
                ...
                function $i(t, e, n) {
                    ...
                    return (
                        (!i && n) ||
                            (("body" === C(e) && !Ni(r)) || (t = (i = e) !== A(i) && T(i) ? { scrollLeft: i.scrollLeft, scrollTop: i.scrollTop } : Mi(i)),
                            T(e) ? (((a = hi(e, !0)).x += e.clientLeft), (a.y += e.clientTop)) : r && (a.x = Pi(r))),
                ...
                function to(t) {
                    ...
                    return function (i, o, e) {
                        ...
                        var n,
                            r,
                            s = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, Zi, d), modifiersData: {}, elements: { reference: i, popper: o }, attributes: {}, styles: {} },
                            a = [],
                            c = !1,
                            l = {
                                state: s,
                                setOptions: function (t) {
                                    var n,
                                        ...
                                        t =
                                            ...
                                            (s.scrollParents = { reference: ii(i) ? Ri(i) : i.contextElement ? Ri(i.contextElement) : [], popper: Ri(o) }),
                                ...
                                forceUpdate: function () {
                                    if (!c) {
                                        var t = s.elements,
                                            ...
                                            t = t.popper;
                                        if (Ji(e, t)) {
                                            (s.rects = { reference: $i(e, _i(t), "fixed" === s.options.strategy), popper: di(t) }),
                                                (s.reset = !1),
                ...
                var eo = to(),
                    no = to({ defaultModifiers: [Si, Xi, Oi, ri, Yi, zi, Ki, xi, Ui] }),
                    io = to({ defaultModifiers: [Si, Xi, Oi, ri] });
                ...
                const co = { allowList: v, content: {}, extraClass: "", html: !1, sanitize: !0, sanitizeFn: null, template: "<div></div>" },
                    lo = { allowList: "object", content: "object", extraClass: "(string|function)", html: "boolean", sanitize: "boolean", sanitizeFn: "(null|function)", template: "string" },
                    uo = { entry: "(string|element|function|null)", selector: "(string|element)" };
                var ho = class extends g {
                    ...
                    _checkContent(t) {
                        for (var [e, n] of Object.entries(t)) super._typeCheckConfig({ selector: e, entry: n }, uo);
                    }
                    _setContent(t, e, n) {
                        n = y.findOne(n, t);
                ...
                class xo extends m {
                    ...
                    dispose() {
                        clearTimeout(this._timeout),
                            f.off(this._element.closest(mo), _o, this._hideModalHandler),
                    ...
                    hide() {
                        if (this._isShown()) {
                            ...
                            if (!t.defaultPrevented) {
                                if ((this._getTipElement().classList.remove(go), "ontouchstart" in document.documentElement)) for (const e of [].concat(...document.body.children)) f.off(e, "mouseover", gt);
                    ...
                    _getTemplateFactory(t) {
                        return (
                            this._templateFactory ? this._templateFactory.changeContent(t) : (this._templateFactory = new ho({ ...this._config, content: t, extraClass: this._resolvePossibleFunction(this._config.customClass) })),
                ...
                const Co = {
                    ...
                    Ao = { ...w.DefaultType, content: "(null|string|element|function)" };
                class To extends w {
                    static get Default() {
                        return Co;
                    }
                ...
                E = To;
                const Oo = "popover",
                    Lo = [{ name: "show" }, { name: "shown" }, { name: "hide" }, { name: "hidden" }, { name: "inserted" }];
                class So extends E {
                    constructor(t, e) {
                        super(t, e), this._init();
                    }
                ...
                const Po = "".concat(g, ", ").concat(".nav-item", " > ").concat(g, ", ").concat(".list-group-item"),
                    No = { offset: null, rootMargin: "0px 0px -25%", smoothScroll: !1, target: null, threshold: [0.1, 0.5, 1] },
                    Ro = { offset: "(number|null)", rootMargin: "string", smoothScroll: "boolean", target: "element", threshold: "array" };
                class Ho extends m {
                    constructor(t, e) {
                        super(t, e),
                            this._config.target &&
                    ...
                    _maybeEnableSmoothScroll() {
                        this._config.smoothScroll &&
                            (f.off(this._config.target, Do),
                            f.on(this._config.target, Do, Mo, (t) => {
                    ...
                    _process(t) {
                        this._activeTarget !== t && (this._clearActiveClass(this._config.target), (this._activeTarget = t).classList.add(jo), this._activateParents(t), f.trigger(this._element, ko, { relatedTarget: t }));
                    }
                    _activateParents(t) {
                        if (t.classList.contains("dropdown-item")) y.findOne(".dropdown-toggle", t.closest(".dropdown")).classList.add(jo);
                        else for (const e of y.parents(t, ".nav, .list-group")) for (const n of y.prev(e, Po)) n.classList.add(jo);
                    }
                    _clearActiveClass(t) {
                ...
                class Vo extends v {
                    ...
                    _bindActivateEvent() {
                        s.on(this._element, Wo, (t) => {
                            this._showSubsection(), this._hideSubsection(), s.trigger(this._element, Fo, { relatedTarget: t.relatedTarget });
                        });
                    }
                }
                s.on(window, g, () => {
                ...
                class or extends m {
                    constructor(t) {
                        super(t),
                            ...
                            this._parent && (this._setInitialAttributes(this._parent, this._getChildren()), f.on(this._element, Go, (t) => this._keydown(t)));
                    }
                    static get NAME() {
                        return "tab";
                    }
                    show() {
                        ...
                        this._elemIsActive(n) ||
                            ((e = (t = this._getActiveElem()) ? f.trigger(t, Yo, { relatedTarget: n }) : null), f.trigger(n, Ko, { relatedTarget: t }).defaultPrevented) ||
                    ...
                    _activate(t, e) {
                        t &&
                            ...
                            this._queueCallback(
                                () => {
                                    "tab" !== t.getAttribute("role") ? t.classList.add(er) : (t.removeAttribute("tabindex"), t.setAttribute("aria-selected", !0), this._toggleDropDown(t, !0), f.trigger(t, $o, { relatedTarget: e }));
                                },
                                t,
                    ...
                    _deactivate(t, e) {
                        t &&
                            ...
                            this._queueCallback(
                                () => {
                                    "tab" !== t.getAttribute("role") ? t.classList.remove(er) : (t.setAttribute("aria-selected", !1), t.setAttribute("tabindex", "-1"), this._toggleDropDown(t, !1), f.trigger(t, Xo, { relatedTarget: e }));
                                },
                                t,
                                t.classList.contains("fade")
                            ));
                    ...
                    _keydown(t) {
                        var e;
                        ["ArrowLeft", Zo, "ArrowUp", Jo].includes(t.key) &&
                            (t.stopPropagation(),
                            t.preventDefault(),
                            (e = [Zo, Jo].includes(t.key)),
                            (t = yt(
                            ...
                            (t.focus({ preventScroll: !0 }), or.getOrCreateInstance(t).show());
                    }
                    _getChildren() {
                ...
                class dr extends E {
                    ...
                    show() {
                        ...
                        if (!this._elemIsActive(n)) {
                            ...
                            var o = s.trigger(n, sr, { relatedTarget: i }),
                                r = s.trigger(n, cr, { relatedTarget: i });
                            ...
                            this._queueCallback(
                                () => {
                                    "tab" !== t.getAttribute("role")
                                        ...
                                        : (t.focus(), t.removeAttribute("tabindex"), t.setAttribute("aria-selected", !0), this._toggleDropDown(t, !0), s.trigger(t, ar, { relatedTarget: e }), s.trigger(t, lr, { relatedTarget: e }));
                                },
                                t,
                                t.classList.contains("fade")
                            ));
                            ...
                            this._queueCallback(
                                () => {
                                    "tab" !== t.getAttribute("role")
                                        ...
                                        : (t.setAttribute("aria-selected", !1), t.setAttribute("tabindex", "-1"), this._toggleDropDown(t, !1), s.trigger(t, "hidden.bs.tab", { relatedTarget: e }), s.trigger(t, hr, { relatedTarget: e }));
                                },
                                t,
                                t.classList.contains("fade")
                            ));
                ...
                var fr = dr;
                const pr = "tooltip",
                    gr = [{ name: "show" }, { name: "shown" }, { name: "hide" }, { name: "hidden" }, { name: "inserted" }];
                class mr extends w {
                    constructor(t, e) {
                        super(t, e), this._init();
                    }
                ...
                class Ir extends m {
                    ...
                    show() {
                        f.trigger(this._element, Cr).defaultPrevented ||
                            (this._clearTimeout(),
                            this._config.animation && this._element.classList.add("fade"),
                            this._element.classList.remove("hide"),
                            mt(this._element),
                            this._element.classList.add(Tr, Or),
                            this._queueCallback(
                                () => {
                    ...
                    hide() {
                        this.isShown() &&
                            !f.trigger(this._element, Er).defaultPrevented &&
                    ...
                    _setListeners() {
                        f.on(this._element, vr, (t) => this._onInteraction(t, !0)),
                            f.on(this._element, br, (t) => this._onInteraction(t, !1)),
                            f.on(this._element, yr, (t) => this._onInteraction(t, !0)),
                            f.on(this._element, wr, (t) => this._onInteraction(t, !1));
                    }
                    _clearTimeout() {
                ...
                _ = Ir;
                const kr = "toast",
                    Dr = [{ name: "show" }, { name: "shown" }, { name: "hide" }, { name: "hidden" }];
                class jr extends _ {
                    constructor(t, e) {
                        super(t, e), this._init();
                    }
                ...
                class j {
                    constructor(t) {
                        (this._element = t),
                            ...
                            this._element && (r.setData(t, Nr, this), this.init());
                    }
                    static get NAME() {
                        return Pr;
                    }
                    ...
                    _applyDivs() {
                        ...
                        c.addClass(e, Hr),
                            ...
                            c.addClass(this._notchLeading, Br),
                            (this._notchMiddle = F("div")),
                            c.addClass(this._notchMiddle, Wr),
                    ...
                    _getElements(t) {
                        ...
                        t && ((this._element = t.target.parentNode), (this._label = a.findOne("label", this._element))),
                            t &&
                                ...
                                ((this._notchMiddle = a.findOne(".form-notch-middle", t.target.parentNode)), (this._notchLeading = a.findOne(Qr, t.target.parentNode)), this._applyNotch());
                    }
                    _deactivate(t) {
                ...
                s.on(document, "focus", Fr, j.activate(new j())),
                    s.on(document, "input", Fr, j.activate(new j())),
                    s.on(document, "blur", Fr, j.deactivate(new j())),
                    s.on(document, "focus", qr, j.activate(new j())),
                    s.on(document, "input", qr, j.activate(new j())),
                    s.on(document, "blur", qr, j.deactivate(new j())),
                ...
                const Zr = "show",
                    ...
                    os = { parent: "(null|element)", toggle: "boolean" };
                class rs extends m {
                    constructor(t, e) {
                            ...
                            if (
                                !(t = this._config.parent
                                    ? this._getFirstLevelChildren(".collapse.show, .collapse.collapsing")
                                          ...
                                          .map((t) => rs.getOrCreateInstance(t, { toggle: !1 }))
                                    : t).length ||
                ...
                f.on(document, w, ns, function (t) {
                    ...
                    t = lt(this);
                    for (const e of y.find(t)) rs.getOrCreateInstance(e, { toggle: !1 }).toggle();
                }),
                    t(rs);
                v = rs;
                const ss = "collapse",
                    as = [{ name: "show" }, { name: "shown" }, { name: "hide" }, { name: "hidden" }];
                class cs extends v {
                    constructor(t) {
                        super(t, 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}), this._init();
                    }
                ...
                a.find('[data-mdb-toggle="collapse"]').forEach((t) => {
                    t = H(t);
                    a.find(t).forEach((t) => {
                        cs.getOrCreateInstance(t, { toggle: !1 });
                    });
                }),
                    o(() => {
                        const t = i();
                ...
                const ms = "show",
                    ...
                    Ts = { autoClose: !0, boundary: "clippingParents", display: "dynamic", offset: [0, 2], popperConfig: null, reference: "toggle" },
                    Os = { autoClose: "(boolean|string)", boundary: "(string|element)", display: "string", offset: "(array|string|function)", popperConfig: "(null|object|function)", reference: "(string|element|object)" };
                class M extends m {
                    constructor(t, e) {
                        super(t, e),
                            (this._popper = null),
                    ...
                    hide() {
                        var t;
                        !ft(this._element) && this._isShown() && ((t = { relatedTarget: this._element }), this._completeHide(t));
                    }
                    dispose() {
                    ...
                    _getPlacement() {
                        ...
                        return e.classList.contains("dropend")
                            ...
                            ? "bottom"
                            : ((t = "end" === getComputedStyle(this._menu).getPropertyValue("--mdb-position").trim()), e.classList.contains("dropup") ? (t ? ws : ys) : t ? xs : Es);
                    }
                    _detectNavbar() {
                ...
                const Ss = { offset: [0, 2], flip: !0, boundary: "clippingParents", reference: "toggle", display: "dynamic", popperConfig: null, dropdownAnimation: "on" },
                    Is = { offset: "(array|string|function)", flip: "boolean", boundary: "(string|element)", reference: "(string|element|object)", display: "string", popperConfig: "(null|object|function)", dropdownAnimation: "string" },
                    ks = "hide.bs.dropdown",
                ...
                class qs extends v {
                    ...
                    _getConfig(t) {
                        t = { ...Ss, ...c.getDataAttributes(this._element), ...t };
                        return W(Ls, t, Is), t;
                    }
                    _getOffset() {
                        const e = this._config["offset"];
                    ...
                    _getPopperConfig() {
                        ...
                        return (
                            "static" === this._config.display && (c.setDataAttribute(this._menu, "popper", "static"), (t.modifiers = [{ name: "applyStyles", enabled: !1 }])),
                            { ...t, ...("function" == typeof this._config.popperConfig ? this._config.popperConfig(t) : this._config.popperConfig) }
                        );
                    }
                    _bindShowEvent() {
                        s.on(this._element, js, (t) => {
                            s.trigger(this._element, Rs, { relatedTarget: t.relatedTarget }).defaultPrevented ? t.preventDefault() : this._dropdownAnimationStart("show");
                        });
                    }
                    _bindShownEvent() {
                        s.on(this._parent, Ms, (t) => {
                            s.trigger(this._parent, Hs, { relatedTarget: t.relatedTarget }).defaultPrevented && t.preventDefault();
                        });
                    }
                    _bindHideEvent() {
                        s.on(this._parent, ks, (t) => {
                            s.trigger(this._parent, Ps, { relatedTarget: t.relatedTarget }).defaultPrevented
                                ? t.preventDefault()
                    ...
                    _bindHiddenEvent() {
                        s.on(this._parent, Ds, (t) => {
                            s.trigger(this._parent, Ns, { relatedTarget: t.relatedTarget }).defaultPrevented
                                ? t.preventDefault()
                ...
                const Qs = "ripple",
                    ...
                    Zs = { rippleCentered: !1, rippleColor: "", rippleDuration: "500ms", rippleRadius: 0, rippleUnbound: !1 },
                    Js = { rippleCentered: "boolean", rippleColor: "string", rippleDuration: "string", rippleRadius: "number", rippleUnbound: "boolean" };
                class ta {
                    constructor(t, e) {
                        (this._element = t),
                            (this._options = this._getConfig(e)),
                            this._element && (r.setData(t, Vs, this), c.addClass(this._element, P)),
                    ...
                    _autoInit(e) {
                        ...
                        this._element.style.minWidth || (c.style(this._element, { "min-width": "".concat(getComputedStyle(this._element).width) }), (this._isMinWidthSet = !0)), c.addClass(this._element, P), this._createRipple(e);
                    }
                    _addClickEvent(t) {
                    ...
                    _createRipple(t) {
                        var e, n, i, o, r, s, a;
                        null !== this._element &&
                            (c.hasClass(this._element, P) || c.addClass(this._element, P),
                            ...
                            (o = { offsetX: this._options.rippleCentered ? n / 2 : t, offsetY: this._options.rippleCentered ? a / 2 : e, height: n, width: a }),
                            (o = this._getDiameter(o)),
                            (r = this._options.rippleRadius || o / 2),
                            (s = { delay: 0.5 * i, duration: i - 0.5 * i }),
                            (a = {
                            ...
                            (t = F("div")),
                            this._createHTMLRipple({ wrapper: this._element, ripple: t, styles: a }),
                            this._removeHTMLRipple({ ripple: t, duration: i }));
                    }
                    _createHTMLRipple(t) {
                        ...
                        this._rippleTimer && (clearTimeout(this._rippleTimer), (this._rippleTimer = null)),
                            (this._rippleTimer = setTimeout(() => {
                                e &&
                                    ...
                                    (a.find(".".concat(Us), this._element).forEach((t) => {
                                        t.remove();
                                    }),
                    ...
                    _addColor(t, e) {
                        Gs.find((t) => t === this._options.rippleColor.toLowerCase())
                            ? c.addClass(e, "".concat(P, "-").concat(this._options.rippleColor.toLowerCase()))
                    ...
                    _colorToRGB(t) {
                        ...
                        return "transparent" === t.toLowerCase()
                            ...
                            : (-1 === t.indexOf("rgb") &&
                                  ...
                                  (i = "rgb(1, 2, 3)"),
                                  (n.style.color = i),
                                  (t = n.style.color !== i || ((n.style.color = e), n.style.color === i) || "" === n.style.color ? $s : ((e = getComputedStyle(n).color), document.body.removeChild(n), e))),
                              0 === t.indexOf("rgb") ? (((i = (i = t).match(/[.\d]+/g).map((t) => +Number(t))).length = 3), i) : $s);
                    }
                ...
                class aa {
                    ...
                    _thumbUpdate() {
                        ...
                        c.style(this._thumb, { left: "calc(".concat(e, "% + (").concat(8 - 0.15 * e, "px))") });
                    }
                    static getInstance(t) {
